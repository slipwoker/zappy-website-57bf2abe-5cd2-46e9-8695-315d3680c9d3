document.addEventListener('DOMContentLoaded', function () {
  ...
  const OBSERVE_CLASS = 'animate-on-scroll';
  ...
  (function injectAnimationStyles() {
    ...
    style.textContent = [
      ...
      '.' + OBSERVE_CLASS + '.animate-visible{opacity:1;transform:translateY(0);}',
      '@media(prefers-reduced-motion:reduce){.' + OBSERVE_CLASS + ',.' + OBSERVE_CLASS + '.' + ANIMATION_CLASS + '{transition:none;opacity:1;transform:none;}}'
    ].join('');
  ...
  function applyScrollAnimations() {
    const candidates = document.querySelectorAll(
      'section, .card, .feature, .testimonial, .pricing, ' +
      '.hero-content, .about-content, .service-item, ' +
  ...
  const mutationObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        if (node.matches && node.matches('section, .card, .feature, [data-animate]')) {
          if (!node.classList.contains(OBSERVE_CLASS)) {
            node.classList.add(OBSERVE_CLASS);
          }
        }
      });
    });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '57bf2abe-5cd2-46e9-8695-315d3680c9d3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '57bf2abe-5cd2-46e9-8695-315d3680c9d3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '57bf2abe-5cd2-46e9-8695-315d3680c9d3';
